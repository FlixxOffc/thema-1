...
check_token() {
  ...
  if [ "$USER_TOKEN" = "flixxhostgagalmoveon" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke Flixxhost${NC}"
    echo -e "${YELLOW}TELEGRAM : @FlixxHost${NC}"
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/FlixxOffc/thema/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer FlixxhostOffc   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : flixxhost      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : FLIXXHOSTOFFC  ${NC}"
